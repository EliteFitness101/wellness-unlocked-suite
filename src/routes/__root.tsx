...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AURA — Luxury Fitness & Lifestyle Membership" },
      {
        name: "description",
        content:
          "AURA is the luxury lifestyle platform of a verified global fitness ambassador: custom meal plans, training, habits and rewards.",
      },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className="theme-feminine">
      <head>
        <HeadContent />
      </head>
      <body>
